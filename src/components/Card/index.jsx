            ...
            {product.data?.map((product, index) => (
              ...
              >
                <div className="relative overflow-hidden group-hover:opacity-75 rounded-lg  ">
                  <img className="object-contain bg-gray-50 h-full w-full lg:h-64 lg:w-64 object-center" src={product.carImage} alt="Product" />
                ...
                <div className="flex items-center justify-between mt-4">
                  <span className="text-gray-900 font-bold text-lg">{product.carPrice}</span>
