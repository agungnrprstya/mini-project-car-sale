      ...
      <body className="bg-white">
        <nav className="mx-auto w-full max-w-7xl relative py-4 flex justify-between items-center bg-white">
          ...
          <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            <li>
              <Link to="/">
                <a className="cursor-pointer text-base text-gray-900 hover:text-blue-600 hover:font-bold">Home</a>
              </Link>
            </li>
            ...
            <li>
              <Link to="/product">
                <a className="cursor-pointer text-base text-gray-900 hover:text-blue-600 hover:font-bold">Product</a>
              </Link>
            </li>
          </ul>
          <a
